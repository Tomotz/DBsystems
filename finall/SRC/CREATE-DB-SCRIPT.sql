...
) ENGINE=InnoDB AUTO_INCREMENT=26785 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
-- Dump completed on 2017-01-23 13:34:13
-- MySQL dump 10.13  Distrib 5.6.23, for Win32 (x86)
--
-- Host: localhost    Database: DbMysql17
-- ------------------------------------------------------
...
CREATE TABLE `Places` (
  ...
  KEY `type_INDEX` (`type`),
  KEY `googleId_INDEX` (`googlePlaceId`),
  CONSTRAINT `addr_id_` FOREIGN KEY (`addr_id`) REFERENCES `Addr` (`idAddr`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=22255 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-01-23 13:34:14
-- MySQL dump 10.13  Distrib 5.6.23, for Win32 (x86)
--
-- Host: localhost    Database: DbMysql17
-- ------------------------------------------------------
...
) ENGINE=MyISAM AUTO_INCREMENT=35181 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-01-23 13:34:20
-- MySQL dump 10.13  Distrib 5.6.23, for Win32 (x86)
--
-- Host: localhost    Database: DbMysql17
-- ------------------------------------------------------
...
CREATE TABLE `Pics` (
  ...
  KEY `googleId_index` (`googlePlaceId`)
) ENGINE=InnoDB AUTO_INCREMENT=54992 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-01-23 13:34:18
